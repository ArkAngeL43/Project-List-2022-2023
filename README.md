...
| SakuraX CSGO | A very informative and well done true EXTERNAL game cheat for CSGO | Redacted | Windows | True | False |
| SakuraX Tarkov | A very well designed internal game cheat for escape from tarkov | Redcated  | Windows | True | False |
| SakuraX Apex   | A very well designed external APEX legends game cheat | Redacted | Windows | True | False |
| FN External    | External game cheat for Fortnite | Redacted | Windows | True | False |
| FN Internal    | Internal game cheat for Fortnite | Redcated | Windows | True | False |
| WoW internal   | Internal game cheat for World Of Warcraft | Redcated | Windows | True | False |
| WoW external   | External game cheat for World Of Warcraft | Redacted | Windows | True | False |
